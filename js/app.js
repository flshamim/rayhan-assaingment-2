    ...
    const displayResult = allData => {
        ...
        if (allData.length === 0) {
            ...
            <div class="card  m-3 shadow-lg">
                <img style="height: 20rem;" class="img-fluid rounded-3 shadow" src="${data.image ? data.image : 'No result'}">
                ...
                <button onclick="phoneDetails('${data.slug}')"  type="button" class="btn btn-dark shadow-lg shadow">
                 Details
                </button>
            </div>
            `
